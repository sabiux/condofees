<?php
/**
 * CondoFees Admin Functions
 *
 * @author      Sabiux
 * @category    Core
 * @package     CondoFees/Admin/Functions
 * @version     0.0.0
 */
...
function wc_get_screen_ids() {
	...
	$wc_screen_id = sanitize_title( __( 'SabiuxCondominio', 'sabiuxcondominio' ) );
	$screen_ids   = array(
